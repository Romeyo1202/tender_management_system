        			...
        			<form name="form1" method="post" action="">
        			  <table width="505" height="98" border="1" align="center">
                        <tr>
                          ...
                          <td><h4 class="style1">Name</h4></td>
                          <td><h4 class="style1">Contact</h4></td>
                          <td><h4 class="style1">Email</h4></td>
                          <td><h4 class="style1">Address</h4></td>
                        </tr>
                        <?php
						$qt=mysql_query("select * from user_details");
