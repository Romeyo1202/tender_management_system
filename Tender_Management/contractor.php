...
if(isset($_POST['btn']))
{
echo  $qry=mysql_query("select * from user_details where username='$uname' and  password='$pass'");
$num=mysql_num_rows($qry);
	if($num==1)
	{
	$_SESSION['contractor']=$uname;
	?>					
					<script language="javascript">
					alert("Login Successfully");
					window.location.href="contractor_home.php";
					</script>
					<?php
	}
else
				...
				<div class="container">
					<div class="banner_content text-center">
						...
						<div class="page_link">
							...
							<a href="manager.php">Manager</a>						</div>
					</div>
				</div>
            </div>
        </section>
        		...
        		<div class="main_title">
        			...
        			<form name="form1" method="post" action="">
        			  <table width="352" height="178" border="0" align="center">
                        ...
                        <tr>
                          <td>&nbsp;</td>
                          <td><a href="contractor_register.php">New User Register Here... </a></td>
                        </tr>
                      </table>
                  </form>
