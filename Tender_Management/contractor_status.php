...
-->
        			...
        			<form name="form1" method="post" action="">
        			  <table width="505" height="98" border="1" align="center">
                        <tr>
                          ...
                          <td><h4 class="style1">material</h4></td>
                          <td><h4 class="style1">workduration</h4></td>
                          <td><h4 class="style1">Status</h4></td>
                        </tr>
                        <?php
						$qt=mysql_query("select * from contract_apply  where contractor='$a'");
		while($r=mysql_fetch_array($qt))																									
	{
                        ...
                        <tr>
						 ...
						 $qt1=mysql_query("select * from contract  where id='$aa'");
