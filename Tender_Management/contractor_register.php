...
$max_qry = mysql_query("select max(id) from user_details");
	...
	$id=$max_row['max(id)']+1;
echo $qry=mysql_query("insert into user_details values('$id','$name','$cont','$email','$address','$username','$pass')");
if($qry)
{
?>
...
<script language="javascript">
alert("Failed..");
window.location.href="contractor_register.php";
</script>
<?php
}
}
      ...
      <div class="banner_inner d-flex align-items-center">
        ...
        <div class="container">
          <div class="banner_content text-center">
            <h2>Contractor</h2>
            <div class="page_link"> <a href="index.php">Home</a> <a href="contractor.php">Contractor</a> </div>
          </div>
        </div>
      </div>
    </section>
