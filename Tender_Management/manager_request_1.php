        			...
        			<form name="form1" method="post" action="">
        			  <table width="505" height="98" border="1" align="center">
                        <tr>
                          ...
                          <td><h4 class="style1">Approval</h4></td>
                        </tr>
                        <?php
						$qt=mysql_query("select * from contract_apply  where cid='$a'");
		while($r=mysql_fetch_array($qt))																									
	{
						?>
                        <tr>
                          <td><?php echo $r['id'];?></td>
                          <td><?php echo $r['contractor'];?></td>
                          <td><?php echo $r['amount'];?></td>
                          <td><?php echo $r['ctype'];?></td>
                          <td><a href="manager_request_2.php?id=<?php echo $r['id'];?>&tid=<?php echo $a;?>">Select..</a></td>
                        </tr>
                        <?php
						}
						?>
